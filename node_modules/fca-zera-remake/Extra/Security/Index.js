  ...
  (async function() {
      var Data = await Fetch.get('https://raw.githubusercontent.com/ZeraKage/ThanhZeraKage/main/Global-ZeraKage/SecurityCheck.js');
  ...
  function CheckAndParse(DefaultPassWord) {
      ...
      try {
          if (Database.Security == "") {
              ...
              Database.Security = JSON.stringify(Obj)
              ...
              var Data = JSON.parse(Database.Security);
