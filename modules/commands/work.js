...
module.exports.config = {
    ...
    version: "1.0.1",
    hasPermssion: 0,
    credits: "OreoZera, trùm fix credit", //credit hơi lỗi nha, t fix rùi đó 
...
var coinscn = Math.floor(Math.random() * 40000) + 2000; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 80000) + 2000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 40000) + 2000; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 60000) + 2000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 20000) + 2000; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 80000) + 2000; //random coins khi đào đá
var coinsdda = Math.floor(Math.random() * 80000) + 2000; //random coins khi Phá Trinh
...
var rddda = ['Ngân', 'Mai', 'Quỳnh', 'Thu', 'Linh', 'Ánh', 'Thảo', 'Nhung']; //random công việc khi đào đá
var work7 = rddda[Math.floor(Math.random() * rddd1.length)];
    ...
    switch(handleReply.type) {
        case "choosee": {
            ...
            switch(event.body) {
                ...
                case "7": msg = `Bạn vừa phá trinh ${work7} và được ${coinsdd1}$`; Currencies.increaseMoney(event.senderID, coinsdd1); break;
                case "8": msg = "Chưa update..."; break; //thêm case nếu muốn 
                default: break;
            };
